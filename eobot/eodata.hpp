...
struct EMF_Tile
{
    ...
    bool Walkable(bool npc = false, bool noWarp = false) const
    {
        if ((this->warp && npc) || (this->warp && noWarp))
        {
            return false;
        }
...
public:
    ...
    bool Walkable(unsigned char x, unsigned char y, bool npc = false, bool noWarp = false) const;
...
public:
    static int SizeTiles(EIF_Data::Size size)
    {
        switch (size)
        {
        case EIF_Data::Size::Size1x1:
            return 1;
        case EIF_Data::Size::Size1x2:
            return 2;
        case EIF_Data::Size::Size1x3:
            return 3;
        case EIF_Data::Size::Size1x4:
            return 4;
        case EIF_Data::Size::Size2x1:
            return 2;
        case EIF_Data::Size::Size2x2:
            return 4;
        case EIF_Data::Size::Size2x3:
            return 6;
        case EIF_Data::Size::Size2x4:
            return 8;
        default:
            return 0;
        }
