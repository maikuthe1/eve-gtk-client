...
template <class T> inline auto cbegin(T &c) -> decltype(c.cbegin())
{
    return c.cbegin();
}
template <class T> inline auto cbegin(const T &c) -> decltype(c.cbegin())
{
    return c.cbegin();
}
template <class T, size_t N> inline const T* cbegin(T(&a)[N])
{
    return a;
}
template <class T> inline auto cend(T &c) -> decltype(c.cbegin())
{
    return c.cend();
}
template <class T> inline auto cend(const T &c) -> decltype(c.cbegin())
{
    return c.cend();
}
template <class T, size_t N> inline const T* cend(T(&a)[N])
{
    return a + N;
}
...
std::string PacketProcessor::GetFamilyName(PacketFamily family)
{
    switch (family)
    {
    case PacketFamily::Internal:
        return "Interal";
    case PacketFamily::Connection:
        return "Connection";
    case PacketFamily::Account:
        return "Account";
    case PacketFamily::Character:
        return "Character";
    case PacketFamily::Login:
        return "Login";
    case PacketFamily::Welcome:
        return "Welcome";
    case PacketFamily::Walk:
        return "Walk";
    case PacketFamily::Face:
        return "Face";
    case PacketFamily::Chair:
        return "Chair";
    case PacketFamily::Emote:
        return "Emote";
    case PacketFamily::Attack:
        return "Attack";
    case PacketFamily::Spell:
        return "Spell";
    case PacketFamily::Shop:
        return "Shop";
    case PacketFamily::Item:
        return "Item";
    case PacketFamily::StatSkill:
        return "StatSkill";
    case PacketFamily::Global:
        return "Global";
    case PacketFamily::Talk:
        return "Talk";
    case PacketFamily::Warp:
        return "Warp";
    case PacketFamily::Jukebox:
        return "Jukebox";
    case PacketFamily::Players:
        return "Players";
    case PacketFamily::Avatar:
        return "Avatar";
    case PacketFamily::Party:
        return "Party";
    case PacketFamily::Refresh:
        return "Refresh";
    case PacketFamily::NPC:
        return "NPC";
    case PacketFamily::PlayerAutoRefresh:
        return "Player_AutoRefresh";
    case PacketFamily::NPCAutoRefresh:
        return "NPC_AutoRefresh";
    case PacketFamily::Appear:
        return "Appear";
    case PacketFamily::Paperdoll:
        return "Paperdoll";
    case PacketFamily::Effect:
        return "Effect";
    case PacketFamily::Trade:
        return "Trade";
    case PacketFamily::Chest:
        return "Chest";
    case PacketFamily::Door:
        return "Door";
    case PacketFamily::Message:
        return "Message";
    case PacketFamily::Bank:
        return "Bank";
    case PacketFamily::Locker:
        return "Locker";
    case PacketFamily::Barber:
        return "Barber";
    case PacketFamily::Guild:
        return "Guild";
    case PacketFamily::Music:
        return "Music";
    case PacketFamily::Sit:
        return "Sit";
    case PacketFamily::Recover:
        return "Recover";
    case PacketFamily::Board:
        return "Board";
    case PacketFamily::Cast:
        return "Cast";
    case PacketFamily::Arena:
        return "Arena";
    case PacketFamily::Priest:
        return "Priest";
    case PacketFamily::Marriage:
        return "Marriage";
    case PacketFamily::AdminInteract:
        return "AdminInteract";
    case PacketFamily::Citizen:
        return "Citizen";
    case PacketFamily::Quest:
        return "Quest";
    case PacketFamily::Book:
        return "Book";
    case PacketFamily::Init:
        return "Init";
    default:
        return "UNKNOWN";
    }
...
std::string PacketProcessor::GetActionName(PacketAction action)
{
    ...
    case PacketAction::Announce:
        return "Announce";
    case PacketAction::Server:
        return "Server";
    case PacketAction::Drop:
        return "Drop";
    case PacketAction::Junk:
        return "Junk";
    case PacketAction::Obtain:
        return "Obtain";
    ...
    case PacketAction::TargetGroup:
        return "TargetGroup";
    case PacketAction::Dialog:
        return "Dialog";
    case PacketAction::InternalNull:
        return "INTERNAL_NULL";
    case PacketAction::InternalWarp:
        return "INTERNAL_WARP";
    case PacketAction::Ping:
        return "Ping";
    case PacketAction::Pong:
        return "Pong";
    case PacketAction::Net3:
        return "Net3";
...
static void debug_packetbuilder_overflow_(PacketBuilder *builder, std::size_t capacity, const char *func)
{
    ...
    //This doesn't exist, not sure why it's here in debug
...
PacketBuilder &PacketBuilder::AddWString(const std::wstring &str)
{
    //this->data += str;
    return *this;
}
